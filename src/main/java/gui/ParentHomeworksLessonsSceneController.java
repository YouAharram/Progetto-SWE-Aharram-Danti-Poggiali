...
public class ParentHomeworksLessonsSceneController {
	...
	public void showAnnotations() {
		...
		try {
			String status = (parentController.checkStudentAttendanceInDay(selectedDate)) ? "Present" : "Absent";
		...
		try {
			lessonsIterator = parentController.getLessonInDate(selectedDate);
		...
		try {
			homeworkIterator = parentController.getHomeworksBySubmissionDate(selectedDate);
	...
	public static void setController(ParentController parentController) {
		ParentHomeworksLessonsSceneController.parentController = parentController;
	}
